...
{#if data.contributor}
	...
	<table class="w-1/2 text-xs border-collapse border border-slate-400">
		<tbody>
			<tr>
				<td class="border border-slate-300 p-1">Handle</td>
			...
			{#if data.contributor.display_name}
				<tr>
					<td class="border border-slate-300 p-1">Display Name</td>
					<td class="border border-slate-300 p-1">
			...
			{#if data.contributor.discord_handle}
				<tr>
					<td class="border border-slate-300 p-1">Discord handle</td>
			...
			{#if data.contributor.github_account}
				<tr>
					...
					<td class="border border-slate-300 p-1">
						<a href={data.contributor.github_account} class="l">{data.contributor.github_account}</a
						>
					</td>
				</tr>
			{/if}
			{#if data.contributor.wiki_account}
				<tr>
					<td class="border border-slate-300 p-1">Wiki contributions</td>
					<td class="border border-slate-300 p-1">
						<a href={data.contributor.wiki_account} class="l">{data.contributor.wiki_account}</a
						></td
					>
				</tr>
			{/if}
			{#if data.contributor.discourse_account}
				<tr>
					<td class="border border-slate-300 p-1">Discourse profile</td>
					<td class="border border-slate-300 p-1"
			...
			{#if data.contributor.website}
				<tr>
					<td class="border border-slate-300 p-1">Personal website</td>
					<td class="border border-slate-300 p-1"
